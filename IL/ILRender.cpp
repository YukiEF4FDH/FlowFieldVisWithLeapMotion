...
namespace ILines
{
	...
	ILRender::ILRender()
	{
		isInitialized = false;
		doZSort = false;
		blinnVertProg = ShaderProgram(GL_VERTEX_PROGRAM);
		blinnTangentVertProg = ShaderProgram(GL_VERTEX_PROGRAM);
		blinnFragProg = ShaderProgram(GL_FRAGMENT_PROGRAM);
		errorCallback = NULL;
	...
	void ILRender::getExtensions()
	{
		extMultitexture = isExtensionSupported("GL_ARB_multitexture");
		...
		pglClientActiveTexture  = (PFNGLCLIENTACTIVETEXTUREPROC)
		                          wglXGetProcAddress("glClientActiveTextureARB");

		// GL_EXT_multi_draw_arrays
		pglMultiDrawArrays      = (PFNGLMULTIDRAWARRAYSPROC)
		                          wglXGetProcAddress("glMultiDrawArraysEXT");

		// GL_ARB_vertex_buffer_object
		pglBindBuffer           = (PFNGLBINDBUFFERPROC)
		                          wglXGetProcAddress("glBindBufferARB");
		pglGenBuffers           = (PFNGLGENBUFFERSPROC)
		                          wglXGetProcAddress("glGenBuffersARB");
		pglDeleteBuffers        = (PFNGLDELETEBUFFERSPROC)
		                          wglXGetProcAddress("glDeleteBuffersARB");
		pglMapBuffer            = (PFNGLMAPBUFFERPROC)
		                          wglXGetProcAddress("glMapBufferARB");
		pglUnmapBuffer          = (PFNGLUNMAPBUFFERPROC)
		                          wglXGetProcAddress("glUnmapBufferARB");
		pglGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIVPROC)
		                          wglXGetProcAddress("glGetBufferParameterivARB");
		pglGetBufferPointerv    = (PFNGLGETBUFFERPOINTERVPROC)
		                          wglXGetProcAddress("glGetBufferPointervARB");
		pglBufferData           = (PFNGLBUFFERDATAPROC)
		                          wglXGetProcAddress("glBufferDataARB");
		...
		pglDeletePrograms       = (PFNGLDELETEPROGRAMSPROC)
	...
	PFNGLBINDBUFFERPROC				ILRender::pglBindBuffer           = NULL;
	PFNGLGENBUFFERSPROC				ILRender::pglGenBuffers           = NULL;
	PFNGLDELETEBUFFERSPROC			ILRender::pglDeleteBuffers        = NULL;
	PFNGLMAPBUFFERPROC				ILRender::pglMapBuffer            = NULL;
	PFNGLUNMAPBUFFERPROC			ILRender::pglUnmapBuffer          = NULL;
	PFNGLGETBUFFERPARAMETERIVPROC	ILRender::pglGetBufferParameteriv = NULL;
	PFNGLGETBUFFERPOINTERVPROC		ILRender::pglGetBufferPointerv    = NULL;
	PFNGLBUFFERDATAPROC				ILRender::pglBufferData           = NULL;
	PFNGLPROGRAMSTRINGPROC			ILRender::pglProgramString        = NULL;
